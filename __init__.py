...
class GIF:
    ...
    def __init__(self,gif_filename,fps=30,dpi=100,loop=0):
        ...
        logging.info('Creating temporary directory %s.'%self.wdir)
        os.mkdir(self.wdir)
    ...
    def add(self,fig):
        ...
        logging.info('Saving figure to file %s.'%outfn)
    ...
    def make(self):
        ...
        logging.info('Running ImageMagick convert to create gif in %s.'%self.gif_filename)
